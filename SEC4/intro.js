 ...
 */
 ...
 // you can see it inside the termnal using VScode press shift + `
 console.log("Hello world");


 // 2 Hello world inside a HTML file with JS
 // this is DOM we will study it along this course but for now we can put something to see throug JS in our HTML 
