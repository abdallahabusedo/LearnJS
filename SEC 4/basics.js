...
var arr = [5, 1, 2, 3, 10];
// array is defined by square practice and it's index is start from 0
...
// if u checking more than question in sequence like x = 0 ? if not check then x = 1 ? and so on u can use else if
if (x == 1) {
...
// This is loop asking for 3 things initial condition or counter ; the question ; at the end do something
for (var i = 0; i < 10; i += 1) {
    console.log("Inside the for loop"); // this will be executed for 10 times
}
